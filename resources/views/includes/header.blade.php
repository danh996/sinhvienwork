                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="navbar-collapse collapse" id="nav-main">
                        <ul class="navbar-nav ml-auto">
							...
							<!-- <li class="nav-item {{ Request::url()}}"><a href="{{url('/companies')}}" class="nav-link">Công ty</a> </li> -->
                            ...
                            @if(Auth::guard('company')->check())
                                <li class="nav-item"><a href="{{route('post.job')}}" class="nav-link text-danger">{{__('Đăng tin')}}</a> </li>
                                <li class="nav-item"><a href="{{route('posted.jobs')}}" class="nav-link text-success">{{__('Tin đã đăng')}}</a> </li>
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item"><a href="{{ route('company.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form-header1').submit();" class="nav-link"><i class="fa fa-sign-out" aria-hidden="true"></i> {{__('Đăng xuất')}}</a> 
                                    </li>
