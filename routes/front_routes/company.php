...
Route::get('thong-tin-nguoi-dung', 'Company\CompanyController@index')->name('company.home');
...
Route::get('tin-da-dang', 'Company\CompanyController@postedJobs')->name('posted.jobs');
