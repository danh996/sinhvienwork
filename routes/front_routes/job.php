...
Route::get('dang-tin', 'Job\JobPublishController@createFrontJob')->name('post.job');
...
Route::get('up-front-job/{id}', 'Job\JobPublishController@upFrontJob')->name('up.front.job');
