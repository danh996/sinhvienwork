...
class JobFrontFormRequest extends Request
{
        ...
        switch ($this->method()) {
            ...
            case 'POST': {
                    ...
                    return [
                        ...
                        "country_id" => "required",
                        //"state_id" => "required",
                        "phone" => ["required","regex:/(0[2|3|5|7|8|9])+[0-9]{8}/"],
    ...
    public function messages()
    {
        return [
            ...
            'description.required' => __('Mô tả công việc không được để trống'),
            'skills.required' => __('Please enter Job skills'),
            'country_id.required' => __('Vui lòng chọn tỉnh thành'),
            'state_id.required' => __('Vui lòng chọn quận huyện'),
            'city_id.required' => __('Please select City'),
            'phone.required' => __('Điện thoại liên hệ không được để trống'),
            'phone.regex' => __('Số điện thoại có định dạng không đúng'),
           ...
           // 'salary_currency.required' => __('Please select salary currency'),
            ...
            'job_type_id.required' => __('Vui lòng chọn ngôn ngữ'),
